...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    features: [
      { icon: '💬', title: 'Multi-Channel Deployment', description: 'One chatbot across website, WhatsApp Business, Instagram, Messenger, and SMS — with consistent context.' },
      { icon: '🧠', title: 'Trained on Your Business', description: 'Custom-trained on your docs, FAQs, product catalog, and tone — not a generic bot.' },
      { icon: '🎯', title: 'Lead Qualification', description: 'Conversational lead capture that qualifies, scores, and routes prospects to the right team member.' },
      { icon: '🌍', title: 'Multilingual', description: 'Native fluency in English, Hindi, and regional Indian languages — plus global languages.' },
      { icon: '🔌', title: 'CRM & Calendar Sync', description: 'Push every chat to your CRM, book meetings directly into your calendar, trigger sequences automatically.' },
      { icon: '📈', title: 'Conversion Analytics', description: 'See which conversations close, which drop off, and what to optimize.' },
    ],
    benefits: [
  ...
  },
  {
    ...
    features: [
      { icon: '📅', title: 'Real-Time Availability', description: 'Live calendar sync across Google, Outlook, and proprietary booking systems.' },
      { icon: '📞', title: 'Multi-Channel Booking', description: 'Customers book via voice call, WhatsApp, web chat, SMS, or email — same intelligent agent.' },
      { icon: '🔔', title: 'Automated Reminders', description: 'Smart reminder sequences via SMS, email, and WhatsApp that reduce no-shows by 40%+.' },
      { icon: '🔄', title: 'Reschedule Handling', description: 'AI handles rescheduling and cancellations conversationally, with no manual coordination.' },
      { icon: '👥', title: 'Multi-Resource Routing', description: 'Books across multiple staff, locations, or service types based on availability and preference.' },
      { icon: '💳', title: 'Payment & Deposits', description: 'Optional deposit collection and payment links during the booking flow.' },
    ],
    benefits: [
  ...
  },
  {
    ...
    features: [
      { icon: '🎯', title: 'AI Prospecting', description: 'Identify your ideal customer profile and surface lookalike accounts automatically.' },
      { icon: '🧬', title: 'Lead Enrichment', description: 'Real-time enrichment with verified emails, phone numbers, firmographics, and tech stack.' },
      { icon: '📡', title: 'Intent Monitoring', description: 'Detect buying signals — funding rounds, hiring spikes, tech changes — before competitors do.' },
      { icon: '✉️', title: 'Personalized Outbound', description: 'AI-generated, hyper-personalized emails and LinkedIn outreach at scale.' },
      { icon: '🛡️', title: 'Deliverability Engineering', description: 'Domain warmup, inbox rotation, and authentication setup so emails land in primary.' },
      { icon: '📊', title: 'Pipeline Reporting', description: 'Live dashboard tracking sourced leads, replies, meetings booked, and pipeline value.' },
    ],
    benefits: [
  ...
  },
  {
    ...
    features: [
      { icon: '🔗', title: 'Cross-Tool Orchestration', description: 'Connect 100+ apps — CRM, email, Slack, sheets, databases, accounting tools — into one workflow.' },
      { icon: '📄', title: 'Document Automation', description: 'Auto-generate, send, and store contracts, invoices, proposals, and reports.' },
      { icon: '📊', title: 'Data Sync & Cleanup', description: 'Keep records consistent across systems with automated deduplication and enrichment.' },
      { icon: '🛎️', title: 'Notification Routing', description: 'Smart alerts to the right people, on the right channel, only when it matters.' },
      { icon: '⏱️', title: 'Scheduled Jobs', description: 'Recurring reports, data pulls, and maintenance tasks running on autopilot.' },
      { icon: '🧯', title: 'Error Recovery', description: 'Built-in retry logic, alerting, and human escalation for graceful failure handling.' },
    ],
    benefits: [
...
export const industries: IndustryData[] = [
  ...
  },
  {
    ...
    stats: [{ value: '4.8★', label: 'Avg review score' }, { value: '30%', label: 'Higher repeat orders' }, { value: '24/7', label: 'Customer availability' }],
  },
  {
